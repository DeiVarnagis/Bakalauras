      ...
      <table class="home_table">
        ...
        <tbody>
          <tr v-for="(message, index) in messages" :key="index">
            ...
            <td data-label="Veiksmas" v-if="message.action == 1">Perdavimas</td>
            <td data-label="Veiksmas" v-if="message.action == 2">Skolinimas</td>
            <td data-label="Veiksmas" v-if="message.action == 3">Grąžinimas</td>
            ...
            <td v-if="message.device_state != 0">Patvirtintas</td>
          </tr>
        </tbody>
      </table>
