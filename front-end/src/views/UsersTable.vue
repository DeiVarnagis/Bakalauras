  ...
  <div class="container">
    <div class="innerDiv">
      ...
      <table class="home_table" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <tr v-for="(user, index) in users" :key="index">
            ...
            <td v-else data-label="Adresas" style="--minWidth: 200px">
              ---------
            </td>
            <td v-if="user.birth" data-label="Gimimo metai">
              {{ user.birth }}
            </td>
            <td v-else data-label="Telefonas" style="--minWidth: 200px">
              ---------
            </td>
            ...
            <td v-if="user.admin" data-label="Adminas" style="--minWidth: 75px">
              Adminas
            </td>
      ...
      <div class="pagination">
        ...
        <button
          @click="
            current_page < last_page ? current_page++ : current_page, getUsers()
          "
        >
    ...
    <ProfileEdit ref="editProfile" @updateProfile="updateProfile"></ProfileEdit>
    <DeleteModal
